...
class SimpleActivityTest {
    ...
    @Test
    fun simpleActivity() {
        val appCompatButton = onView(withId(R.id.btn_simple_activity))
        ...
        assertEquals(
            mActivityTestRule.activity.applicationContext.getString(R.string.hello_world),
            "您好世界"
        )
        ...
        assertEquals(
            mActivityTestRule.activity.baseContext.getString(R.string.hello_world),
            "Ciao mondo"
        )
        assertEquals(
            mActivityTestRule.activity.applicationContext.getString(R.string.hello_world),
